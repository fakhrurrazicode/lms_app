...
class CourseSectionController extends Controller
{
    ...
    public function index(Request $request, Course $course)
    {
        ...
        return Inertia::render('Backend/Course/CourseSection/Index', [
            'course' => $course,
    ...
    public function course_lectures(Request $request, Course $course)
    {
        ...
        return Inertia::render('Backend/Course/CourseSection/CourseLectures', [
            'course' => $course,
            'course_sections' => $course_sections,
        ]);
    }
    ...
    public function evaluations(Request $request, Course $course)
    {
        ...
        return Inertia::render('Backend/Course/CourseSection/Evaluations', [
            'course' => $course,
            'course_sections' => $course_sections,
        ]);
    }
    ...
    public function create(Course $course)
    {
        ...
        // return 'test';
        return Inertia::render('Backend/Course/CourseSection/Create', compact('course'));
    }
    ...
    {
        return Inertia::render('Backend/Course/CourseSection/Edit', compact('course', 'course_section'));
    }
