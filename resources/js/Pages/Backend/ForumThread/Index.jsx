...
export default function Index({ request, forum_threads }) {
                                            ...
                                            threads.data.map((user) => (
                                                ...
                                                >
                                                    <th>
                                                        ...
                                                        <Link
                                                            href={route(
                                                                "backend.forum_thread.edit_password",
                                                                user.id
                                                            )}
