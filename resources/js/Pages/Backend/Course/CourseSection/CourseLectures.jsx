...
export default function CourseLectures({ course, course_sections }) {
    const courseSectionDeleteHandler = (course_section) => {
        if (
            ...
            router.delete(
                route("backend.course.course_section.destroy", {
    ...
    const courseLectureDeleteHandler = (course_lecture) => {
        if (
            ...
            router.delete(
                route("backend.course.course_section.course_lecture.destroy", {
                            ...
                            <div className="overflow-x-auto">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm">
                                        ...
                                        bagian atau modul yang lebih
                                        terstruktur. Setiap Bagian biasanya
                                        berisi sekelompok topik terkait yang
                                        membantu peserta kursus memahami materi
                                        secara bertahap.
                                    </p>
                                </div>
                                <div className="mb-6">
                                    <div>
                                        <Link
                                            href={route(
                                                "backend.course.course_section.create",
                                                {
                                                    course: course.id,
                                                }
                                            )}
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    <td className="flex gap-1">
                                                                        <Link
                                                                            href={route(
                                                                                "backend.course.course_section.edit",
                                                                                {
                                                                                    course: course_section.course_id,
                                                                                    course_section:
                                                                                        course_section.id,
                                                                        ...
                                                                        <Link
                                                                            href={route(
                                                                                "backend.course.course_section.course_lecture.create",
                                                                                {
                                                                                    course: course_section.course_id,
                                                                                    course_section:
                                                                                        course_section.id,
                                                                        ...
                                                                        (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td>
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(
                                                                                            ...
                                                                                            router.put(
                                                                                                route(
                                                                                                    "backend.course.course_section.course_lecture.set_as_preview",
                                                                                                    {
                                                                                                        course: course.id,
                                                                                                        course_section:
                                                                                                            course_section.id,
                                                                                ...
                                                                                <td>
                                                                                    <input
                                                                                        ...
                                                                                        onChange={(
                                                                                            ...
                                                                                            router.put(
                                                                                                route(
                                                                                                    "backend.course.course_section.course_lecture.set_as_featured",
                                                                                                    {
                                                                                                        course: course.id,
                                                                                                        course_section:
                                                                                                            course_section.id,
                                                                                ...
                                                                                <td className="flex gap-1">
                                                                                    <Link
                                                                                        href={route(
                                                                                            "backend.course.course_section.course_lecture.edit",
                                                                                            {
                                                                                                course: course_lecture.course_id,
                                                                                                course_section:
