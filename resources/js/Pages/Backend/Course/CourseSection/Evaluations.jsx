...
export default function Evaluations({ course, course_sections }) {
    ...
    const evaluationDeleteHandler = (evaluation) => {
        if (
            ...
            router.delete(
                route("backend.course.course_section.evaluation.destroy", {
                    course: course.id,
                                                            ...
                                                            >
                                                                ...
                                                                <td>
                                                                    <Link
                                                                        ...
                                                                        href={route(
                                                                            "backend.course.course_section.evaluation.create",
                                                                            {
                                                                                course: course_section.course_id,
                                                                                course_section:
                                                                                    course_section.id,
                                                                ...
                                                                <>
                                                                    <tr className="hover">
                                                                        ...
                                                                        <td className="flex gap-1">
                                                                            <Link
                                                                                href={route(
                                                                                    "backend.course.course_section.evaluation.edit",
                                                                                    {
                                                                                        course: course_section.course_id,
                                                                                        course_section:
                                                                                            course_section.id,
                                                                            ...
                                                                            <Link
                                                                                href={route(
                                                                                    "backend.course.course_section.evaluation.question.create",
                                                                                    {
                                                                                        course: course_section.course_id,
                                                                                        course_section:
                                                                                            course_section.id,
                                                                                ...
                                                                                <>
                                                                                    <tr className="hover">
                                                                                        ...
                                                                                        <td className="flex gap-1">
                                                                                            <Link
                                                                                                href={route(
                                                                                                    "backend.course.course_section.evaluation.question.edit",
                                                                                                    {
                                                                                                        course: course_section.course_id,
                                                                                                        course_section:
                                                                                                            course_section.id,
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <input
                                                                                                                ...
                                                                                                                onChange={(
                                                                                                                    ...
                                                                                                                    router.put(
                                                                                                                        route(
                                                                                                                            "backend.course.course_section.evaluation.question.choice.set_as_correct_answer",
                                                                                                                            {
                                                                                                                                course: course.id,
                                                                                                                                course_section:
                                                                                                                                    course_section.id,
