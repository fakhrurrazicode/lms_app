...
export default function Edit({ referral_code, events, owners }) {
    const { data, setData, put, errors, reset, processing, progress } = useForm(
        {
            code: referral_code.code,
            event_id: referral_code.event_id,
            owner_id: referral_code.owner_id,
            customer_coin_reward: referral_code.customer_coin_reward,
            owner_coin_reward: referral_code.owner_coin_reward,
            usage_limit: referral_code.usage_limit,
            used_count: referral_code.used_count,
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        put(
            route("backend.referral_code.update", {
                            ...
                            <div className="card-body">
                                ...
                                <div className="mb-6">
                                    ...
                                    <label className="form-control w-full mb-6">
                                        ...
                                        <input
                                            type="text"
                                            placeholder="Referral Code Code"
