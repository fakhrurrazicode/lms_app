                            ...
                            <div className="prose !max-w-full">
                                <div>
                                    ...
                                    <p>
                                        ...
                                        information when You use the Service and
                                        tells You about Your privacy rights and
                                    ...
                                    <ul>
                                        <li>
                                            <p>
                                                ...
                                                unique account created for You
                                                to access our Service or parts
                                                of our Service.
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                                <strong>Affiliate</strong> means
                                                an entity that controls, is
                                                controlled by or is under common
                                                control with a party, where
                                                "control" means ownership of 50%
                                                or more of the shares, equity
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                this Agreement) refers to PT
                                                Ayootech Indonesia Industry,
                                                PIK2 Rukan Osaka OTPA No. 18
                                                Salembaran Jati, Kec. Kosambi,
                                                Kabupaten Tangerang, Banten
                                                15214 Kabupaten Banten, Jawa
                                                Barat 15214.
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                                ...
                                                small files that are placed on
                                                Your computer, mobile device or
                                                any other device by a website,
                                                containing the details of Your
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                any device that can access the
                                                Service such as a computer, a
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                automatically, either generated
                                                by the use of the Service or
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                to GuruTeknik, accessible from{" "}
                                                <a
                                                    href="https://guruteknik.com"
                                                    rel="external nofollow noopener"
                                                    target="_blank"
                                                >
                                                    https://guruteknik.com
                                                </a>
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                                ...
                                                individual accessing or using
                                                the Service, or the company, or
                                                other legal entity on behalf of
                                                which such individual is
                                    ...
                                    <p>
                                        ...
                                        information. Tracking technologies used
                                        are beacons, tags, and scripts to
                                        collect and track information and to
                                        improve and analyze Our Service. The
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Your Device. You can instruct Your
                                            ...
                                            some parts of our Service. Unless
                                            you have adjusted Your browser
                                        ...
                                        <li>
                                            ...
                                            our emails may contain small
                                            electronic files known as web
                                            beacons (also referred to as clear
                                            gifs, pixel tags, and single-pixel
                                            gifs) that permit the Company, for
                                            example, to count users who have
                                            visited those pages or opened an
                                            email and for other related website
                                            statistics (for example, recording
                                            the popularity of a certain section
                                            and verifying system and server
                                            integrity).
                                        </li>
                                    </ul>
                                    <p>
                                        Cookies can be "Persistent" or "Session"
                                        Cookies. Persistent Cookies remain on
                                        Your personal computer or mobile device
                                        when You go offline, while Session
                                        Cookies are deleted as soon as You close
                                        Your web browser. Learn more about
                                        cookies on the{" "}
                                        <a
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p>
                                                ...
                                                essential to provide You with
                                                services available through the
                                                Website and to enable You to use
                                                some of its features. They help
                                                to authenticate users and
                                                prevent fraudulent use of user
                                                accounts. Without these Cookies,
                                                the services that You have asked
                                                for cannot be provided, and We
                                                only use these Cookies to
                                        ...
                                        <li>
                                            ...
                                            <p>
                                                ...
                                                if users have accepted the use
                                        ...
                                        <li>
                                            ...
                                            <p>
                                                ...
                                                to remember choices You make
                                                when You use the Website, such
                                                as remembering your login
                                                details or language preference.
                                                The purpose of these Cookies is
                                                to provide You with a more
                                                personal experience and to avoid
                                                You having to re-enter your
                                    ...
                                    <p>
                                        ...
                                        or the Cookies section of our Privacy
                                        Policy.
                                    </p>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                to manage Your registration as a
                                                user of the Service. The
                                                Personal Data You provide can
                                                give You access to different
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                contract for the products, items
                                                or services You have purchased
                                                or of any other contract with Us
                                                through the Service.
                                            </p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                general information about other
                                                goods, services and events which
                                                we offer that are similar to
                                        ...
                                        <li>
                                            <p>
                                                ...
                                                other sale or transfer of some
                                                or all of Our assets, whether as
                                                a going concern or as part of
                                                bankruptcy, liquidation, or
                                                similar proceeding, in which
                                                Personal Data held by Us about
                                                our Service users is among the
                                                assets transferred.
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                                ...
                                                improve our Service, products,
                                                services, marketing and your
                                                experience.
                                            </p>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            to monitor and analyze the use of
                                    ...
                                    <p>
                                        ...
                                        13. If You are a parent or guardian and
                                        ...
                                        under the age of 13 without verification
                                    ...
                                    <ul>
                                        <li>
                                            By email: support@guruteknik.com
                                        </li>
                                    </ul>
                                </div>
                            </div>
