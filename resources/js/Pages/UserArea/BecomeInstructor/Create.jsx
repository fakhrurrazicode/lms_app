            ...
            <div className="card bg-base-100">
                <div className="card-body">
                    {auth.user.instructor_info ? (
                        <>
                            {auth.user.instructor_info.status == 0 ? (
                                        ...
                                        <div className="card bg-base-100 py-6">
                                            <div className="card-body flex flex-col items-center">
                                                ...
                                                <h3 className="text-lg font-bold">
                                                    ...
                                                    Sebagai Pengajar telah kami
                                                    terima.
                                                </h3>
                                                <p className="mb-6">
                                                    Harap menunggu proses
                                                    evaluasi pengajuan anda.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {auth.user.instructor_info.status == 1 ? (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <div className="col-span-3">
                                        <div className="card bg-base-100 py-6">
                                            <div className="card-body flex flex-col items-center">
                            ...
                            {auth.user.instructor_info.status == 2 ? (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <div className="col-span-3">
                                        <div className="card bg-base-100 py-6">
                                            <div className="card-body flex flex-col items-center">
