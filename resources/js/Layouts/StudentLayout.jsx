...
export default function UserLayout({ children }) {
    ...
    return (
        <div className="relative font-inter font-normal text-base leading-[1.8] bg-bodyBg dark:bg-bodyBg-dark">
            ...
            <main className="bg-transparent">
                <section>
                    <div className="container-fluid-2">
                        <div className="bg-skycolor p-5 md:p-10 rounded-5 flex justify-center md:justify-between items-center flex-wrap gap-2">
                            ...
                            <div>
                                {/* <a
                                    ...
                                    className="text-size-15 text-whiteColor bg-secondaryColor px-25px py-10px border border-secondaryColor hover:text-secondaryColor hover:bg-whiteColor rounded group text-nowrap flex gap-1 items-center"
                                >
                                    Create a New Course
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
